...
insert into public.doctors (
  ...
  college_name, credential_name, credential_year, registration_number,
  photo_alt, is_published
) values (
  'dr-tp-yadav',
  1,
  'Dr T P Yadav',
  'Founder & Chief Homeopathic Physician | BHMS, MD',
  ...
  null,
  'Dr. Madan Pratap Khuteta Homoeopathic Medical College, Jaipur',
  'BHMS, MD',
  null,
  '3692',
...
insert into public.doctors (
  slug, display_order, full_name, role_title, header_subline,
  bio_paragraphs, short_bio, specializations, philosophy_quote,
  consultation_points, college_name, credential_name, credential_year,
  registration_number, photo_alt, is_published
) values (
  'dr-anavil-yadav',
  2,
  'Dr Anavil Yadav',
...
on conflict (slug) do update set
  ...
  college_name = excluded.college_name,
  credential_name = excluded.credential_name,
  credential_year = excluded.credential_year,
  registration_number = excluded.registration_number,
  is_published = excluded.is_published;
