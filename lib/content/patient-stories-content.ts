...
export const patientStoriesHero = {
  ...
  trustLine:
    "All stories reflect real patient experiences at our clinic | Shared anonymously to protect patient privacy | Individual results vary",
};
...
export const PATIENT_STORIES: PatientStoryEntry[] = [
  ...
  },
  {
    ...
    attribution: "Parent, Ahmedabad — Childhood Eczema — 3 months of treatment",
    conditionSlug: "skin-diseases",
  ...
  },
  {
    ...
    title: "CKD — Meaningful Kidney Function Improvement in 6 Months.",
    quote:
      "My father's kidney health had declined significantly and his nephrologist recommended close monitoring. We were desperate for additional support. My cousin suggested Dr Yadav. We started homeopathic treatment alongside his existing medicines. Over the next 6 months, his kidney function showed meaningful, sustained improvement. We continue to share his blood reports every 6 weeks with his nephrologist. We thank God and Yadav Homeo Clinic every single day. Individual results vary.",
    attribution: "Patient, Jaipur — Chronic Kidney Disease — 6 months of treatment",
  ...
  },
  {
    ...
    attribution: "Patient, Jodhpur — Recurrent Kidney Stones — 18 months of treatment",
    conditionSlug: "renal-diseases",
  ...
  },
  {
    ...
    attribution: "Parent, Jaipur — Severe Autism — 2 years of treatment",
  ...
  },
  {
    ...
    attribution: "Parent, Udaipur — ADHD — 7 months of treatment",
    conditionSlug: "autism",
    conditionLabel: "ADHD",
  },
  {
    ...
    attribution: "Patient, Mumbai — PCOS — 7 months of treatment",
  ...
  },
  {
    ...
    attribution: "Patient, Jaipur — Uterine Fibroids — 9 months of treatment",
    conditionSlug: "womens-health",
  ...
  },
  {
    ...
    attribution: "Patient, Jaipur — Chronic Migraine — 8 months of treatment",
  ...
  },
  {
    ...
    attribution: "Parent, Jaipur — Epilepsy — 11 months of treatment (adjunctive)",
    conditionSlug: "nervous-system-disease",
