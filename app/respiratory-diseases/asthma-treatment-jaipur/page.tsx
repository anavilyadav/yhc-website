...
import { ASTHMA_PAGE } from "@/lib/content/asthma-content";
    ...
    <>
      ...
      <div className="mx-auto max-w-4xl px-5 pb-2">
        <p className="text-[13px] text-text-mid">
          Looking for other chronic respiratory conditions we treat — sinusitis, allergic rhinitis, COPD?{" "}
          <Link href={`/${page.parentSlug}`} className="font-semibold text-amber-dark hover:text-navy">
            Visit our Respiratory Diseases page →
          </Link>
        </p>
      </div>
